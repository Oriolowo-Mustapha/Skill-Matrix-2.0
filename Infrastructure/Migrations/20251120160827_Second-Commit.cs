    ...
    public partial class SecondCommit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Admins",
                columns: new[] { "Id", "DateJoined", "Email", "FirstName", "LastName", "PasswordHash", "Role", "UserName" },
                values: new object[] { new Guid("f4b1f8b4-5b4a-4b4a-8b4a-5b4a4b4a4b4a"), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "superAdmin@gmail.com", "Super", "Admin", "$2a$12$EGOawab0.yM2V9ZqlNwuxuDRiPQ1nsIM9M4rsfWwqzNzy1Y8qBl1u", 1, "Superadmin" });
