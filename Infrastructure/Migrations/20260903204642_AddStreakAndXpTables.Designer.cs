...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260903204642_AddStreakAndXpTables")]
    partial class AddStreakAndXpTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.AssignedCareerPath", b =>
                {
                    ...
                    b.Property<Guid?>("CareerPathTrackId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.CareerPathTrack", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.UserStreak", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.XpAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            ActionType = "ImprovementTaskCompleted",
                            BaseXp = 20,
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Complete an improvement task",
                            UpdatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Id = new Guid("a1000000-0000-0000-0000-000000000003"),
                            ActionType = "PeerEndorsed",
                            BaseXp = 10,
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Receive a peer endorsement",
                            UpdatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Id = new Guid("a1000000-0000-0000-0000-000000000004"),
                            ActionType = "SkillMastered",
                            BaseXp = 100,
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Master a skill (reach Expert level)",
                            UpdatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Id = new Guid("a1000000-0000-0000-0000-000000000005"),
                            ActionType = "BadgeUnlocked",
                            BaseXp = 30,
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            ...
                            ActionType = "CareerPathCompleted",
                            BaseXp = 200,
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Complete a career path",
                            UpdatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Id = new Guid("a1000000-0000-0000-0000-000000000007"),
                            ActionType = "BaselineCompleted",
                            BaseXp = 25,
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Complete a baseline assessment",
                            UpdatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.AssignedCareerPath", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.CareerPathTrack", "CareerPathTrack")
                        .WithMany()
                        .HasForeignKey("CareerPathTrackId");
